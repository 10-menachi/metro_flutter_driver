...
import 'package:metroberry/app/models/admin_commission.dart';
import 'package:metroberry/app/models/coupon_model.dart';
import 'package:metroberry/app/models/distance_model.dart';
import 'package:metroberry/app/models/location_lat_lng.dart';
import 'package:metroberry/app/models/positions.dart';
import 'package:metroberry/app/models/vehicle_type_model.dart';
...
class BookingModel {
  ...
  factory BookingModel.fromJson(Map<String, dynamic> json) => BookingModel(
        ...
        dropLocation: json['dropLocation'] != null
            ? LocationLatLng.fromJson(json['dropLocation'])
            : null,
        pickUpLocation: json['pickUpLocation'] != null
            ? LocationLatLng.fromJson(json['pickUpLocation'])
            : null,
        ...
        rejectedDriverId: json["rejectedDriverId"] == null
            ? []
            : List<dynamic>.from(json["rejectedDriverId"]!.map((x) => x)),
        taxList: json["taxList"] == null
            ? []
            : List<TaxModel>.from(
                json["taxList"]!.map((x) => TaxModel.fromJson(x))),
        ...
        distance: json["distance"] == null
            ? null
            : DistanceModel.fromJson(json["distance"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "rejectedDriverId": rejectedDriverId == null
            ? []
            : List<dynamic>.from(rejectedDriverId!.map((x) => x)),
        "taxList":
            taxList == null ? [] : (taxList!.map((x) => x.toJson()).toList()),
