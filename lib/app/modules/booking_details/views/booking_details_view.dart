...
import 'package:metroberry/app/models/tax_model.dart';
import 'package:metroberry/app/models/user_model.dart';
import 'package:metroberry/app/models/wallet_transaction_model.dart';
import 'package:metroberry/app/modules/booking_details/widget/price_row_view.dart';
import 'package:metroberry/app/modules/chat_screen/views/chat_screen_view.dart';
import 'package:metroberry/app/modules/home/views/home_view.dart';
import 'package:metroberry/app/modules/reason_for_cancel/views/reason_for_cancel_view.dart';
...
import 'package:metroberry/constant_widgets/app_bar_with_border.dart';
import 'package:metroberry/constant_widgets/custom_dialog_box.dart';
import 'package:metroberry/constant_widgets/pick_drop_point_view.dart';
...
import 'package:metroberry/constant_widgets/title_view.dart';
import 'package:metroberry/extension/date_time_extension.dart';
                ...
                children: [
                                      ...
                                      if (value == true) {
                                        ...
                                        DriverUserModel? driverModel =
                                            await FireStoreUtils
                                                .getDriverUserProfile(controller
                                        ...
                                        await SendNotification.sendOneNotification(
                                            ...
                                            driverId: controller
                                                ...
                                                .toString(),
                                            body:
                                                'Your ride has been rejected by ${driverModel!.fullName}.',
                                            payload: playLoad);
                  ...
                  if (controller.bookingModel.value.bookingStatus ==
                    ...
                    RoundShapeButton(
                      ...
                      onTap: () {
                        controller.getBookingDetails();
                        if (controller.bookingModel.value.paymentType !=
                                        ...
                                        await FireStoreUtils.updateTotalEarning(
                                            amount: (double.parse(
                                                    ...
                                                    double.parse(Constant.calculateAdminCommission(
                                                            amount:
                                                                Constant.calculateFinalAmount(controller.bookingModel.value)
                                                                    .toString(),
                                                            adminCommission:
                                                                controller
                                                                    .bookingModel
                                      ...
                                      if (controller.bookingModel.value
                                        ...
                                        WalletTransactionModel
                                            ...
                                            WalletTransactionModel(
                                                ...
                                                userId: controller.bookingModel
                                                    .value.driverId,
                                                note:
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              CachedNetworkImage(
                                imageUrl:
                                    controller.bookingModel.value.vehicleType ==
                                            null
                      ...
                      FutureBuilder<UserModel?>(
                          future: FireStoreUtils.getUserProfile(
                              controller.bookingModel.value.customerId ?? ''),
                      ...
                      PickDropPointView(
                        pickUpAddress: controller
                            ...
                            '',
                        dropAddress:
                            controller.bookingModel.value.dropLocationAddress ??
                                '',
                      ),
                      TitleView(
