...
class HomeController extends GetxController {
  ...
  getUserData() async {
    ...
    await FireStoreUtils.getDriverUserProfile(FireStoreUtils.getCurrentUid())
        .then((value) {
      if (value != null) {
        userModel.value = value as DriverUserModel;
      }
    });
  ...
  updateCurrentLocation() async {
    ...
    if (permissionStatus == PermissionStatus.granted) {
      ...
      location.onLocationChanged.listen((locationData) {
        ...
        FireStoreUtils.getDriverUserProfile(FireStoreUtils.getCurrentUid())
            .then((value) {
          DriverUserModel driverUserModel = value! as DriverUserModel;
