...
import 'package:metroberry/app/modules/my_wallet/controllers/my_wallet_controller.dart';
...
import 'package:metroberry/constant_widgets/text_field_with_title.dart';
                          ...
                          child: RadioListTile(
                            ...
                            title: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    controller.bankDetailsList[index].bankName
                                        .toString(),
                                    style: GoogleFonts.inter(
                                      color: themeChange.isDarkTheme()
                                          ? AppThemData.white
                                  ...
                                  Text(
                                    controller
                                        .bankDetailsList[index].accountNumber
                                        .toString(),
                                    style: GoogleFonts.inter(
                                      color: themeChange.isDarkTheme()
                                          ? AppThemData.white
                                  ...
                                  Text(
                                    controller.bankDetailsList[index].holderName
                                        .toString(),
                                    style: GoogleFonts.inter(
                                      color: themeChange.isDarkTheme()
                                          ? AppThemData.white
                    ...
                    onTap: () async {
                      if (controller.formKey.value.currentState!.validate()) {
                        if (double.parse(controller.userModel.value.walletAmount
                          ...
                          if (controller
                              .withdrawalAmountController.value.text.isEmpty) {
