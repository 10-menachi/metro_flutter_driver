...
import 'package:metroberry/app/modules/add_bank/views/add_bank_view.dart';
                                          ...
                                          if (value == "Edit") {
                                            ...
                                            controller.bankNameController.text =
                                                bankDetailsModel.bankName
                                                    .toString();
                                            controller.bankBranchCityController
                                                    .text =
                                                bankDetailsModel.branchCity
                                                    .toString();
                                            controller
                                                    .bankBranchCountryController
                                                    .text =
                                                bankDetailsModel.branchCountry
                                                    .toString();
                                            Get.to(const AddBankView());
                                          } else {
